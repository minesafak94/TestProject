...
public class Task3 {
    public static void main(String[] args) {
      /*3) Write a program that reads a
        range of integers (start and end point),
       ...
       int endingP=input.nextInt();

       System.out.println("start "+startP+" end "+endingP);

       int evenSum=0;
       int oddSum=0;

       for (int i=startP;i<=endingP;i++) {
           if (i % 2 == 0) {
               evenSum+=i;// can also be written like evenSum=evenSum+1
